    ...
    <div className="min-h-screen bg-[var(--bg-surface)]">
      <div className="mx-auto max-w-3xl px-6 py-16">
        ...
        <div className="prose prose-gray max-w-none space-y-8 text-[var(--text-secondary)]">
          ...
          <section>
            <h2 className="text-xl font-semibold text-[var(--text-primary)] mb-3">1. Who We Are</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-[var(--text-primary)] mb-3">2. What Data We Collect</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-[var(--text-primary)] mb-3">7. International Transfers</h2>
            <p>
