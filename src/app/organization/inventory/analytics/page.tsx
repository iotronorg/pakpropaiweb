  ...
  return (
    <div className="space-y-7 pb-10">
      <div className="flex items-center gap-3">
        <Link href="/organization/inventory" className="text-sm text-[var(--text-muted)] hover:text-[var(--text-primary)]">
          &larr; Inventory
        </Link>
        <h1 className="text-2xl font-bold text-[var(--text-primary)]">Property Analytics</h1>
      </div>
      ...
      <div>
        <div className="flex items-center gap-3 mb-4">
          ...
          <select
            ...
            className="ms-auto rounded-lg border border-[var(--border)] bg-[var(--bg-surface)] px-3 py-1.5 text-sm text-[var(--text-muted)] focus:outline-none focus:ring-2 focus:ring-blue-100"
          >
        ...
        {avgPriceTrend.length > 0 ? (
          ...
          <div className="rounded-xl border border-[var(--border)] bg-[var(--bg-surface)] p-8 text-center text-sm text-[var(--text-muted)]">
      ...
      {topCities.length > 0 && (
        <div className="rounded-xl border border-[var(--border)] bg-[var(--bg-surface)] p-5">
          <h3 className="text-sm font-semibold text-[var(--text-muted)] mb-4">Average Price by City</h3>
            ...
            {topCities.map(([cityName, avgPrice]) => {
              ...
              return (
                <div key={cityName} className="flex items-center gap-3">
                  <span className="w-24 text-xs text-[var(--text-muted)] font-medium truncate">{cityName}</span>
                  ...
                  <span className="text-xs font-semibold text-[var(--text-muted)] w-20 text-right tabular-nums">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        <div className="rounded-xl border border-[var(--border)] bg-[var(--bg-surface)] p-5">
          <h3 className="text-sm font-semibold text-[var(--text-muted)] mb-4">Risk Level</h3>
      ...
      <div className="rounded-xl border border-[var(--border)] bg-[var(--bg-surface)] p-5">
        <h3 className="text-sm font-semibold text-[var(--text-muted)] mb-4">Listings by City</h3>
