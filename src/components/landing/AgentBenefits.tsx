...
export default function AgentBenefits() {
  ...
  return (
    <section id="agents" ref={ref} className="bg-slate-50 py-24 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <span className="inline-block bg-sky-50 text-sky-700 border border-sky-100 text-xs font-semibold uppercase tracking-widest px-4 py-1.5 rounded-full mb-4">
          ...
          >
            Close More Deals.
            <br />
            <span className="text-sky-600">Do Less Chasing.</span>
          </h2>
        ...
        <motion.div
          ...
          className="mt-8 mb-14 flex flex-wrap justify-center gap-2.5"
        >
        ...
        >
          ...
          <p className="mt-3 text-sm text-slate-400">No credit card. No commitment. Start receiving leads within 24 hours of approval.</p>
        </motion.div>
      </div>
    </section>
  );
