  ...
  return (
    <section id="clients" ref={ref} className="bg-white py-24 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <div>
            <span className="inline-block bg-slate-100 text-slate-600 border border-slate-200 text-xs font-semibold uppercase tracking-widest px-4 py-1.5 rounded-full mb-4">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {benefits.map(({ icon: Icon, title, description }, i) => (
            <motion.div
              ...
              className="flex flex-col gap-4 p-5 rounded-xl border border-slate-200 hover:border-blue-200 hover:bg-blue-50/20 transition-all duration-200"
            >
