...
const NAV_ITEMS: Record<string, NavItem[]> = {
  admin: [
    ...
    { label: "Market Trends",href: "/admin/market-trends",     icon: "📉" },
    ...
    { label: "Compare",      href: "/admin/properties/compare",icon: "🔀" },
    ...
    { label: "System Log",    href: "/admin/audit-log",         icon: "🗂️" },
    { label: "Notifications", href: "/admin/notifications",     icon: "🔔" },
    { label: "Settings",      href: "/admin/settings",          icon: "⚙️" },
  ],
  agent: [
    { label: "Overview",     href: "/agent",                   icon: "⬛" },
    { label: "Analytics",    href: "/agent/analytics",         icon: "📈" },
    ...
    { label: "Notifications", href: "/agent/notifications",     icon: "🔔" },
  ],
  developer: [
    { label: "Overview",     href: "/developer",               icon: "⬛" },
    { label: "Analytics",    href: "/developer/analytics",     icon: "📈" },
    ...
    { label: "Notifications", href: "/developer/notifications", icon: "🔔" },
    { label: "Settings",      href: "/developer/settings",      icon: "⚙️" },
  ],
};
